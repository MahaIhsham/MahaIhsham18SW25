         ...
         public static void main(String args [])
         			{
         				...
         				obj[0]=new Student();
         				obj[0].SetInfo("Maha",25,"Muet");
         				obj[1]=new Student();
         				obj[1].SetInfo("Areeba",20,"Muet");
                                        obj[2]=new Student();
         				obj[2].SetInfo("Dania",12,"Muet");
         				obj[3]=new Student();
         				obj[3].SetInfo("Rafia",18,"Muet");
         				obj[4]=new Student();
         				...
         				obj[7]=new Student();
         				obj[7].SetInfo("Umesh",20,"Muet");
         				obj[8]=new Student();
         				obj[8].SetInfo("Romana",19,"Muet");
         				obj[9]=new Student();
         				obj[9].SetInfo("Unsa",22,"Muet");
